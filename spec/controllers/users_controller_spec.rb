...
describe UsersController do
  ...
  describe "GET 'index'" do
    ...
    describe "for signed-in_user" do
  ...
  describe "POST 'create'" do
   ...
   describe "success" do
     ...
     before(:each) do
       @attr = { :name => "New User", :email => "use@example.com", 
  ...
  describe "authentication of the edit/update actions" do
    ...
    describe "for signed-in-users" do
      ...
      it "should requrie matching users for 'edit'" do
        get :edit, :id => @user
  ...
  describe "DELETE 'destory'" do
    ...
    describe "as a non-signed-in user" do
      it "should deny access" do
        ...
        redirect_to.should redirect_to(signin_path)
      end
    end
    ...
    describe "as an admin user" do
      ...
      it "should be not be able to  destroy itself" do
        lambda do
